...
The three journeys that already download a file
(`test_git_output_timeseries`, `test_collaboration_card_evidence`,
`test_metric_evidence_drilldown`) predate this rule and still stop at suffix
and size. Copy their locators and their page objects, not their assertions.
