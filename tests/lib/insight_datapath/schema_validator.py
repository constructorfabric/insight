...
_CACHE: dict[tuple[Path, str], dict[str, Any]] = {}


def load_schema(schemas_dir: Path, table: str) -> dict[str, Any]:
...
def pad_and_validate(
    record: dict[str, Any], schema: dict[str, Any], *, table: str
) -> dict[str, Any]:
