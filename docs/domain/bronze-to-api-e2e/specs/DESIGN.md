...
| `GET` | `/v1/persons/{email}` | Person lookup via the identity service — out of v1 scope per PRD §4.2; exercised only for its declared error contract (the rig's masked 500) | deprecated |
