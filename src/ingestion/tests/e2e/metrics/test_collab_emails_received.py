...
def test_collab_emails_received(spec: SpecRun) -> None:
    ...
    by_tool = one(r.breakdown("collab.emails_received"), entity_id=ERIN, dimensions={"key": "tool", "value": "m365"})
    ...
    r = spec.call(
        {
            ...
            "body": {
                ...
                "metrics": [{"metric_key": "collab.emails_received", "views": [{"view": "period"}]}],
            },
        }
    )
    assert r.status == 200
