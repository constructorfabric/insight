                ...
                "metrics": [
                    {
                        ...
                        "views": [{"view": "period"}, {"view": "breakdown", "dimensions": ["hour_block"]}],
                    }
                ],
            },
        }
...
def test_each_branch_scope_breaks_down_over_the_same_dimension(spec: SpecRun) -> None:
    ...
    r.row("git.default_branch_commits", "breakdown", entity_id=ALICE, dimensions=hour_block("08")).equals(value=3)
    r.row("git.non_default_branch_commits", "breakdown", entity_id=ALICE, dimensions=hour_block("20")).equals(value=1)
