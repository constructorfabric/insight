...
def test_collab_files_shared_internal(spec: SpecRun) -> None:
    ...
    by_tool = one(
        r.breakdown("collab.files_shared_internal"), entity_id=ERIN, dimensions={"key": "tool", "value": "m365"}
    )
    ...
    by_scope = one(r.breakdown("collab.files_shared"), entity_id=ERIN, dimensions={"key": "scope", "value": "internal"})
