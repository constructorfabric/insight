...
def test_tasks_resolution_time(spec: SpecRun) -> None:
    ...
    by_source = one(r.breakdown("tasks.resolution_time"), entity_id=ERIN, dimensions={"key": "source", "value": "jira"})
...
def test_tasks_resolution_time_by_issue_type(spec: SpecRun) -> None:
    ...
    r = spec.call(
        {
            ...
            "body": {
                ...
                "period": {"from": "2026-12-20", "to": "2026-12-31"},
                "metrics": [
                    {"metric_key": "tasks.resolution_time", "views": [{"view": "breakdown", "dimensions": ["type"]}]}
                ],
            },
        }
    )
    ...
    by_type = one(r.breakdown("tasks.resolution_time"), entity_id=ERIN, dimensions={"key": "type", "value": "Task"})
