...
def test_ai_cost(spec: SpecRun) -> None:
    ...
    r.row("ai.cost", "peer", entity_id=ERIN).equals(target_value=3, p25=1.2, median=1.8, p75=2.4, min=0.6, max=3, n=5)
    ...
    by_tool = one(r.breakdown("ai.cost"), entity_id=ERIN, dimensions={"key": "tool", "value": "claude_code"})
