...
(
    ...
    `n_new_sessions_total` Nullable(Int64),
    `n_user_messages_total` Nullable(Int64),
    `n_tasks_web` Nullable(Int64),
    `n_code_reviews_web` Nullable(Int64),
    `credit_total` Nullable(Decimal(38, 9)),
    `on_demand_credits` Nullable(Decimal(38, 9)),
    `uncached_text_input_tokens` Nullable(Int64),
    `cached_text_input_tokens` Nullable(Int64),
    `text_output_tokens` Nullable(Int64),
    `text_total_tokens` Nullable(Int64),
    ...
    `n_new_sessions_cli` Nullable(Int64),
    `n_new_sessions_vscode` Nullable(Int64),
    `n_new_sessions_exec` Nullable(Int64),
    `n_new_sessions_sdk_ts` Nullable(Int64),
    `n_new_sessions_desktop` Nullable(Int64),
    `n_new_sessions_work_desktop` Nullable(Int64),
    `n_new_sessions_work_web` Nullable(Int64),
    `n_new_sessions_work_mobile` Nullable(Int64),
    `n_new_sessions_other` Nullable(Int64),
    `n_user_messages_cli` Nullable(Int64),
    `n_user_messages_vscode` Nullable(Int64),
    `n_user_messages_exec` Nullable(Int64),
    `n_user_messages_sdk_ts` Nullable(Int64),
    `n_user_messages_desktop` Nullable(Int64),
    `n_user_messages_work_desktop` Nullable(Int64),
    `n_user_messages_work_web` Nullable(Int64),
    `n_user_messages_work_mobile` Nullable(Int64),
    `n_user_messages_other` Nullable(Int64)
)
ENGINE = ReplacingMergeTree(_airbyte_extracted_at)
ORDER BY unique_key
SETTINGS allow_nullable_key = 1, index_granularity = 8192
