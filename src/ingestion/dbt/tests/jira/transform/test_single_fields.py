...
POINTS_FIELD = field(STORY_POINTS, name="Story Points", schema_type="number")
...
@case(fields=[POINTS_FIELD], issues=[issue("TST-1", fields={STORY_POINTS: 5})])
...
@case(
    fields=[POINTS_FIELD],
    issues=[issue("TST-1", fields={STORY_POINTS: 5})],
    events=[event("TST-1", 101, "2026-02-20T10:00:00", [item(STORY_POINTS, frm="3", frm_str="3", to="5", to_str="5")])],
)
...
@case(fields=[POINTS_FIELD], issues=[issue("TST-1", fields={})])
...
@case(
    ...
    events=[event("TST-1", 101, "2026-01-06T10:00:00", [item(REMAINING, frm=None, frm_str=None, to="0", to_str="0")])],
)
...
@case(
    ...
    issues=[issue("TST-1", fields={REMAINING: None})],
    events=[
        event("TST-1", 101, "2026-01-06T10:00:00", [item(REMAINING, frm="28800", frm_str="28800", to="0", to_str="0")])
    ],
)
...
@case(fields=[POINTS_FIELD], issues=[issue("TST-1", fields={STORY_POINTS: 0})])
